package com.example.mediapipeaudioclassification
...
import com.example.mediapipeaudioclassification.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
    ...
    private fun allPermissionsGranted(): Boolean = ContextCompat.checkSelfPermission(
        this, REQUIRED_PERMISSION
    ) == PackageManager.PERMISSION_GRANTED

    override fun onResume() {
        super.onResume()
        if (isRecording) audioClassifierHelper.startAudioClassification()
    }

    override fun onPause() {
        super.onPause()
        if (::audioClassifierHelper.isInitialized) audioClassifierHelper.stopAudioClassification()
    }

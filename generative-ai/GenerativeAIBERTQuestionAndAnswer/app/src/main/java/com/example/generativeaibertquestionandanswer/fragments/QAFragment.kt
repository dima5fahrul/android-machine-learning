package com.example.generativeaibertquestionandanswer.fragments
...
import com.example.generativeaibertquestionandanswer.BertQAHelper
import com.example.generativeaibertquestionandanswer.DataSetClient
import com.example.generativeaibertquestionandanswer.R
import com.example.generativeaibertquestionandanswer.adapters.ChatHistoryAdapter
import com.example.generativeaibertquestionandanswer.adapters.QuestionSuggestionsAdapter
import com.example.generativeaibertquestionandanswer.databinding.FragmentQABinding
import com.example.generativeaibertquestionandanswer.models.Message
...
class QAFragment : Fragment() {
    ...
    private fun setQuestion(optionID: Int) {
        binding.tietQuestion.setText(
            topicSuggestedQuestions[optionID]
        )
    }

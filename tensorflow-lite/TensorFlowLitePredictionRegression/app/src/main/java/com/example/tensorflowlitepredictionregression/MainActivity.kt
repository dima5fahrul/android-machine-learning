package com.example.tensorflowlitepredictionregression

import android.os.Bundle
import android.widget.Toast
import androidx.appcompat.app.AppCompatActivity
import com.example.tensorflowlitepredictionregression.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        predictionHelper = PredictionHelper(context = this,
